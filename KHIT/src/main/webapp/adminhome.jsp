...
<style>
  ...
  * {
  ...
  .grid-container {
    ...
    padding-left: 150px;
    padding-top: 50px;
    position: relative; /* Make sure .grid-container is positioned relative */
  }
  ...
  .reset-button {
    ...
    top: 20px;
    right: 20px;
    background-color: #ff004f; /* Background color for the reset button */
    border: none;
    color: #fff;
    padding: 10px 20px;
    text-align: center;
...
<body>
    <div class="dashboard">
        ...
        <a href="truncate_tables.jsp" class="reset-button">Reset DB</a> <!-- Reset DB button at top right -->
