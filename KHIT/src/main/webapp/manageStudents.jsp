...
<head>
    ...
    <style>
        ...
        * {
        ...
        label {
            color: #FFCB9A; /* Light pink for labels */
            font-size: 18px;
            display: block;
            margin-bottom: 10px;
        ...
        input[type="text"]:focus, select:focus {
            border-color: #FFCB9A; /* Light pink border on focus */
            background-color: rgba(51, 51, 51, 0.9); /* Slightly darker background on focus */
            outline: none;
        ...
        a {
            display: block;
            text-align: center;
            color: #FFCB9A; /* Light pink for links */
        ...
        a:hover {
            color: #ff004f; /* Darker pink on hover */
        ...
        .back-button:hover {
            background-color: #FFCB9A; /* Light pink background on hover */
            color: #333; /* Dark text on hover */
        }

        .message {
            text-align: center;
            color: #FFCB9A; /* Light pink for messages */
            margin: 20px 0;
            animation: fadeInUp 1s ease-out;
        }
...
<body>
    ...
    <a class="back-button" href="adminhome.html">Back to Admin Dashboard</a>
    <!-- Display the message -->
    <div class="message">
        <p>
